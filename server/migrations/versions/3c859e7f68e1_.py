...
Revision ID: 3c859e7f68e1
Revises: 
Create Date: 2023-04-23 20:41:25.997204
...
def upgrade():
    ...
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('starting_destination', sa.String(), nullable=False),
    sa.Column('final_destination', sa.String(), nullable=False),
