...
export function User(){
    ...
    <div className="bg-slate-700 px-3 pb-2 pt-2 h-screen">
      ...
      <form action="submit" onSubmit={handleSubmit}>
        ...
        <label className="text-white p-4 flex justify-between">E-mail
        <input
        ...
        <label className="text-white p-4 flex justify-between">Password
        <input
        ...
        <label className="text-white p-4 flex justify-between">Date of birth
        <input
        ...
        <label className="text-white p-4 flex justify-between">Phone number
        <input
        ...
        <label className="text-white p-4 flex justify-between">Role
        <input
