...
export function Preplanned_Trip(){
    ...
    <div className="bg-slate-700 px-3 pb-2 pt-2 ">
      <h1 className="text-white text-xl pl-5">TicketingSystemPreplanned</h1>
      <form action="submit" onSubmit={handleSubmit}>
        ...
        <label className="p-4">Starting Destination
        <input
        ...
        <label className="p-4">Final Destination
        <input
        ...
        <label className="p-4">Number of Seats
        <input
        ...
        <label className="p-4">Booked Seats
        <input
        ...
        <label className="p-4">Start Date
        <input
